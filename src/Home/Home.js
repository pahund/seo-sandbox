...
function addTimeout(handler, delay) {
    timeoutHandles.add(window.setTimeout(handler, delay));
}
...
class Home extends Component {
    ...
    componentDidMount() {
        addTimeout(() => this.setState(Object.assign(this.state, {
    ...
    render() {
        ...
        return (
            <div className="Home">
                ...
                <p className="Home-technical-note">
    ...
    renderDelayed(delayedText) {
        return delayedText ? <p>{delayedText}</p> : <p className="Home-please-wait">(please wait…)</p>
    }
}
